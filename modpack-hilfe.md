...
<div class="np-help-grid" id="mitspielen">
  <a class="np-help-tile" href="#installation">
    ...
    <span>NewPath über CurseForge installieren</span>
  </a>

  <a class="np-help-tile" href="#ram">
    <strong>RAM zuweisen</strong>
    <span>Arbeitsspeicher im Launcher prüfen</span>
  </a>
...
<details id="ram" class="np-help-details">
