...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Schnellstart</p>
    <h1 class="np-title">Empfohlene Reihenfolge</h1>
  </div>

  <div class="np-card-grid np-card-grid-4 np-help-flow">
    <div class="np-info-card">
      <span class="np-card-kicker">1</span>
      <strong class="np-card-title">Installieren</strong>
      <p class="np-card-text">Modpack über CurseForge suchen und installieren.</p>
    </div>
    <div class="np-info-card">
      <span class="np-card-kicker">2</span>
      <strong class="np-card-title">RAM prüfen</strong>
      <p class="np-card-text">Dem Modpack genug Arbeitsspeicher zuweisen.</p>
    </div>
    <div class="np-info-card">
      <span class="np-card-kicker">3</span>
      <strong class="np-card-title">Voice Chat testen</strong>
      <p class="np-card-text">Mikrofon, Ausgabe und Lautstärke einstellen.</p>
    </div>
    <div class="np-info-card">
      <span class="np-card-kicker">4</span>
      <strong class="np-card-title">Whitelist klären</strong>
      <p class="np-card-text">Discord und Zugangsinformationen prüfen.</p>
    </div>
  </div>
</section>
...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Setup</p>
    <h1 class="np-title">Installation & Setup</h1>
  </div>

  <details id="installation" class="np-accordion np-help-details">
    ...
    <div>
      ...
      <div class="np-card-media np-help-image-placeholder">
        Bildplatzhalter: CurseForge-Installationsgrafik später hier einfügen.
      </div>
    </div>
  </details>

  <details id="ram" class="np-accordion np-help-details">
    <summary>RAM im CurseForge Launcher zuweisen</summary>
    <div>
      <p>
      ...
      <div class="np-note np-help-warning">
...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Kommunikation</p>
    <h1 class="np-title">Voice Chat & Kommunikation</h1>
  </div>

  <details id="voice-chat" class="np-accordion np-help-details">
...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Serverfunktionen</p>
    <h1 class="np-title">Wichtige Serverfunktionen</h1>
  </div>
...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Mod-Guides</p>
    <h1 class="np-title">Mod-Anleitungen</h1>
  </div>

  <div class="np-card-grid np-card-grid-2 np-help-topic-list" id="mod-guides">
    <div class="np-info-card">
      <strong class="np-card-title">Geplante Themen</strong>
      <span class="np-card-text">Kurze Guides zu Mods und Funktionen, die häufig Fragen auslösen.</span>
    </div>
    <div class="np-info-card">
      <strong class="np-card-title">Format</strong>
      <span class="np-card-text">Kurzer Erklärungstext, klare Schritte, optional Bild oder Beispiel.</span>
    </div>
  </div>
...
<section class="np-page-section np-help-section">
  <div class="np-section-header">
    <p class="np-eyebrow">Support</p>
    <h1 class="np-title">Probleme & Support</h1>
  </div>

  <details id="probleme" class="np-accordion np-help-details">
